function [thresh, Eval] = findthresholdCC(imagestruct, thresh_start, thresh_step, thresh_end, radius, scale)
...
% @Author: Christoph Baur
    ...
    for thresh = thresh_start:thresh_step:thresh_end
        ...
        Eval = CNN.evaluateCC(imagestruct, thresh, radius, scale, '', false, false);
