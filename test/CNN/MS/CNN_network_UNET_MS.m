...
block = dagnn.Conv('size', [3 3 512 256], 'hasBias', 1, 'pad', [0 0], 'stride', [1 1]);
...
block = dagnn.Conv('size', [3 3 256 128], 'hasBias', 1, 'pad', [0 0], 'stride', [1 1]);
...
block = dagnn.Conv('size', [3 3 192 64], 'hasBias', 1, 'pad', [0 0], 'stride', [1 1]);
...
net.addLayer('loss', dagnn.DiceLoss(), {'prediction','label'}, 'objective') ;
