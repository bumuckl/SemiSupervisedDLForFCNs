% Creates the UNET network architecture for medical image segmentation in a fully convolutional way, with BatchNormalization
%
...
block = dagnn.BatchNorm('numChannels', numInputChannels, 'epsilon', 1e-05);
net.addLayer('input_bn', block, {'input'}, {'input_bn'}, {'input_bn_mult', 'input_bn_bias', 'input_bn_moments'});

block = dagnn.Conv('size', [3 3 numInputChannels 64], 'hasBias', 1, 'pad', [1 1], 'stride', [1 1]);
net.addLayer('conv_d0ab', block, {'input_bn'}, {'conv_d0ab'}, {'conv_d0ab_filter', 'conv_d0ab_bias'});

block = dagnn.BatchNorm('numChannels', 64, 'epsilon', 1e-05);
net.addLayer('conv_d0ab_bn', block, {'conv_d0ab'}, {'conv_d0ab_bn'}, {'conv_d0ab_bn_mult', 'conv_d0ab_bn_bias', 'conv_d0ab_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d0ab_relu', block, {'conv_d0ab_bn'}, {'conv_d0ab_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 64, 'epsilon', 1e-05);
net.addLayer('conv_d0bc_bn', block, {'conv_d0bc'}, {'conv_d0bc_bn'}, {'conv_d0bc_bn_mult', 'conv_d0bc_bn_bias', 'conv_d0bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d0bc_relu', block, {'conv_d0bc_bn'}, {'conv_d0bc_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 128, 'epsilon', 1e-05);
net.addLayer('conv_d1ab_bn', block, {'conv_d1ab'}, {'conv_d1ab_bn'}, {'conv_d1ab_bn_mult', 'conv_d1ab_bn_bias', 'conv_d1ab_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d1ab_relu', block, {'conv_d1ab_bn'}, {'conv_d1ab_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 128, 'epsilon', 1e-05);
net.addLayer('conv_d1bc_bn', block, {'conv_d1bc'}, {'conv_d1bc_bn'}, {'conv_d1bc_bn_mult', 'conv_d1bc_bn_bias', 'conv_d1bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d1bc_relu', block, {'conv_d1bc_bn'}, {'conv_d1bc_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 256, 'epsilon', 1e-05);
net.addLayer('conv_d2ab_bn', block, {'conv_d2ab'}, {'conv_d2ab_bn'}, {'conv_d2ab_bn_mult', 'conv_d2ab_bn_bias', 'conv_d2ab_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d2ab_relu', block, {'conv_d2ab_bn'}, {'conv_d2ab_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 256, 'epsilon', 1e-05);
net.addLayer('conv_d2bc_bn', block, {'conv_d2bc'}, {'conv_d2bc_bn'}, {'conv_d2bc_bn_mult', 'conv_d2bc_bn_bias', 'conv_d2bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d2bc_relu', block, {'conv_d2bc_bn'}, {'conv_d2bc_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 512, 'epsilon', 1e-05);
net.addLayer('conv_d3ab_bn', block, {'conv_d3ab'}, {'conv_d3ab_bn'}, {'conv_d3ab_bn_mult', 'conv_d3ab_bn_bias', 'conv_d3ab_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d3ab_relu', block, {'conv_d3ab_bn'}, {'conv_d3ab_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 512, 'epsilon', 1e-05);
net.addLayer('conv_d3bc_bn', block, {'conv_d3bc'}, {'conv_d3bc_bn'}, {'conv_d3bc_bn_mult', 'conv_d3bc_bn_bias', 'conv_d3bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_d3bc_relu', block, {'conv_d3bc_bn'}, {'conv_d3bc_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 256, 'epsilon', 1e-05);
net.addLayer('conv_u2bc_bn', block, {'conv_u2bc'}, {'conv_u2bc_bn'}, {'conv_u2bc_bn_mult', 'conv_u2bc_bn_bias', 'conv_u2bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u2bc_relu', block, {'conv_u2bc_bn'}, {'conv_u2bc_relu'}, {});

block = dagnn.Conv('size', [3 3 256 256], 'hasBias', 1, 'pad', [1 1], 'stride', [1 1]);
net.addLayer('conv_u2cd', block, {'conv_u2bc_relu'}, {'conv_u2cd'}, {'conv_u2cd_filter', 'conv_u2cd_bias'});

block = dagnn.BatchNorm('numChannels', 256, 'epsilon', 1e-05);
net.addLayer('conv_u2cd_bn', block, {'conv_u2cd'}, {'conv_u2cd_bn'}, {'conv_u2cd_bn_mult', 'conv_u2cd_bn_bias', 'conv_u2cd_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u2cd_relu', block, {'conv_u2cd_bn'}, {'conv_u2cd_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 128, 'epsilon', 1e-05);
net.addLayer('conv_u1bc_bn', block, {'conv_u1bc'}, {'conv_u1bc_bn'}, {'conv_u1bc_bn_mult', 'conv_u1bc_bn_bias', 'conv_u1bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u1bc_relu', block, {'conv_u1bc_bn'}, {'conv_u1bc_relu'}, {});

block = dagnn.Conv('size', [3 3 128 128], 'hasBias', 1, 'pad', [1 1], 'stride', [1 1]);
net.addLayer('conv_u1cd', block, {'conv_u1bc_relu'}, {'conv_u1cd'}, {'conv_u1cd_filter', 'conv_u1cd_bias'});

block = dagnn.BatchNorm('numChannels', 128, 'epsilon', 1e-05);
net.addLayer('conv_u1cd_bn', block, {'conv_u1cd'}, {'conv_u1cd_bn'}, {'conv_u1cd_bn_mult', 'conv_u1cd_bn_bias', 'conv_u1cd_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u1cd_relu', block, {'conv_u1cd_bn'}, {'conv_u1cd_relu'}, {});
...
block = dagnn.BatchNorm('numChannels', 64, 'epsilon', 1e-05);
net.addLayer('conv_u0bc_bn', block, {'conv_u0bc'}, {'conv_u0bc_bn'}, {'conv_u0bc_bn_mult', 'conv_u0bc_bn_bias', 'conv_u0bc_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u0bc_relu', block, {'conv_u0bc_bn'}, {'conv_u0bc_relu'}, {});

block = dagnn.Conv('size', [3 3 64 64], 'hasBias', 1, 'pad', [1 1], 'stride', [1 1]);
net.addLayer('conv_u0cd', block, {'conv_u0bc_relu'}, {'conv_u0cd'}, {'conv_u0cd_filter', 'conv_u0cd_bias'});

block = dagnn.BatchNorm('numChannels', 64, 'epsilon', 1e-05);
net.addLayer('conv_u0cd_bn', block, {'conv_u0cd'}, {'conv_u0cd_bn'}, {'conv_u0cd_bn_mult', 'conv_u0cd_bn_bias', 'conv_u0cd_bn_moments'});

block = dagnn.ReLU();
net.addLayer('conv_u0cd_relu', block, {'conv_u0cd_bn'}, {'conv_u0cd_relu'}, {});
...
net.addLayer('loss', dagnn.FbetaLoss('updateBeta', false, 'beta_lr', 100), {'prediction','label'}, 'objective', {'beta'}) ;
