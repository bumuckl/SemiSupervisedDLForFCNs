% Finetune an existing Network using both labeled and "unlabeled" data. Do it in a "grid search"
% way with different params to get a comparison of different models
%
